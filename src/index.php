...
<main class="form">
    ...
    <form action="procesar.php" method="post" autocomplete="off">
        ...
        <div class="mb-3">
            ...
            <input type="password" name="contraseña" class="form-control" autocomplete="new-password">
        </div>

        <div class="mb-3">
            <label for="codigo" class="form-label">Código de verificación</label>
            <input type="text" name="codigo" class="form-control" placeholder="Ingresa el texto de la imagen" autocomplete="off">
        </div>
